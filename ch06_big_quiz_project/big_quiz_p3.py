...
def handle_game_over():
    global next_question, time_left
    ...
    # "q" maps to the message variable instead
    next_question = {
        "q": message,
        "o": ["-", "-", "-", "-"], # all answer options are empty
        "a": -1                    # there is no correct answer
    }
...
# TODO: Define a function correct_answer(), it does not take in parameters, and it does not return a value
#       Inside, write code to increase the score by 1

# TODO: After (inside correct_answer() still):-
#       if there are any questions left in the list,
