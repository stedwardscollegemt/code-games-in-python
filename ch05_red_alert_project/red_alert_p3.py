...
def on_mouse_down(pos):
    ...
    # TODO:
    # if they did, check whether the star image is red_star
    # if the star clicked is red, then call on_red_star_click()
    # otherwise, call handle_game_over()

# TODO: a function on_red_star_click()
#       when a red star is clicked on, then stop_animations()
#       and the player moves up to another level, unless
#       the player reached the FINAL_LEVEL, in which case, game_complete = True

# TODO: a function stop_animations()
#       loop through animations[]
#       for every animation in the list
#       if animation.running is True 
#       then animation.stop()
